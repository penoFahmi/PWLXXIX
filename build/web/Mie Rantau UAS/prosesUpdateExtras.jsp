<%-- 
    Document   : prosesUpdateExtras
    Created on : 1 Jul 2024, 08.06.46
    Author     : Peno
--%>
...
<html>
    <head>
        ...
        <title>Proses Update Extras</title>
    </head>
    <body>
        <%
            ...
            if (ID != null && name != null && description != null && price != null && photo_url != null) {
                try {
                    ...
                    String query = "UPDATE extras SET name = ?, description = ?, price = ?, photo_url = ? WHERE ID = ?";
                    ...
                    if (i > 0) {
                        ...
                        out.println("Failed to update extras.");
                    }
                } catch(Exception e) {
