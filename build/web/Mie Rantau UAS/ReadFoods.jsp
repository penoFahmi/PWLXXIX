<%-- 
    Document   : ReadFoods
    Created on : 30 Jun 2024, 20.54.16
    Author     : Peno
--%>
                    ...
                    <tbody>
                        <% while(resultSet.next()) { %>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="deleteFoods.jsp?ID=<%= resultSet.getString("id") %>" class="btn btn-danger">Delete</a>
                                        <a href="updateFoods.jsp?ID=<%= resultSet.getString("id") %>" class="btn btn-warning">Update</a>
                                    </div>
                                </td>
                            </tr>
                        <% }
