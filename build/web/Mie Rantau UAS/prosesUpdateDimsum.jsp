<%-- 
    Document   : prosesUpdateDimsum
    Created on : 1 Jul 2024, 08.06.07
    Author     : Peno
--%>
...
<html>
    <head>
        ...
        <title>Proses Update Dimsum</title>
    </head>
    <body>
        <%
            ...
            if (ID != null && name != null && description != null && price != null && photo_url != null) {
                try {
                    ...
                    String query = "UPDATE dimsum SET name = ?, description = ?, price = ?, photo_url = ? WHERE ID = ?";
