<%-- 
    Document   : createExtras
    Created on : 1 Jul 2024, 02.40.08
    Author     : Peno
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="shadow-lg p-5 br-4">
                    <h1 class="text-center mb-4">Tambah Extra</h1>
                    <form method="post" action="createExtras.jsp">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Tambahan Extra/<label>
    ...
    <%
        ...
        if (nama != null && harga != null) {
            try {
                ...
                String query = "INSERT INTO extras (name, description, price, photo_url) VALUES (?,?,?,?)";
