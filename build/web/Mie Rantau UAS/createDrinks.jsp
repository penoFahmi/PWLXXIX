<%-- 
    Document   : createDrinks
    Created on : 1 Jul 2024, 02.39.50
    Author     : Peno
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="shadow-lg p-5 br-4">
                    <h1 class="text-center mb-4">Tambah Minuman Baru</h1>
                    <form method="post" action="createDrinks.jsp">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Minumanan</label>
    ...
    <%
        ...
        if (nama != null && harga != null) {
            try {
                ...
                String query = "INSERT INTO drinks (name, description, price, photo_url) VALUES (?,?,?,?)";
