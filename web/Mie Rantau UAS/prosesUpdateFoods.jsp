<%-- 
    Document   : prosesUpdateFoods
    Created on : 1 Jul 2024, 08.06.30
    Author     : Peno
--%>
...
<html>
    <head>
        ...
        <title>Proses Update Makanan</title>
    </head>
    <body>
        <%
            ...
            if (ID != null && name != null && description != null && price != null && photo_url != null) {
                try {
                    ...
                    String query = "UPDATE foods SET name = ?, description = ?, price = ?, photo_url = ? WHERE ID = ?";
                    ...
                    if (i > 0) {
                        ...
                        out.println("Failed to update foods.");
                    }
                } catch(Exception e) {
