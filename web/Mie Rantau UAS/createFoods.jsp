<%-- 
    ...
    Created on : 1 Jul 2024, 02.39.26
    Author     : Peno
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="shadow-lg p-5 br-4">
                    <h1 class="text-center mb-4">Menambahkan Makanan</h1>
                    <form method="post" action="createFoods.jsp">
                        <div class="mb-3">
    ...
    <%
        ...
        if (nama != null && harga != null) {
            try {
                ...
                String query = "INSERT INTO foods (name, description, price, photo_url) VALUES (?,?,?,?)";
