<%-- 
    Document   : updateFoods
    Created on : 1 Jul 2024, 08.08.28
    Author     : Peno
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="shadow-lg p-5 br-4">
                    <h1 class="text-center mb-4">Update Makanan</h1>
                    <%
                        ...
                        if (ID != null) {
                             ...
                             try {
                                ...
                                if (resultSet.next()) {
                    %>
                    <form method="post" action="prosesUpdateFoods.jsp">
                        ...
                        out.println("Foods not found.");
                            ...
                            out.println("Error: " + e.getMessage());
                                ...
                                if (connection != null) try { connection.close(); } catch (SQLException ignore) {}
                                    ...
                                    out.println("No Foods ID provided.");
                                    }
                    %>
                </div>
            </div>
