<%-- 
    Document   : updateDimsum
    Created on : 1 Jul 2024, 08.07.24
    Author     : Peno
--%>
                    ...
                    <%
                        ...
                        if (ID != null) {
                             ...
                             try {
                                ...
                                String query = "SELECT * FROM dimsum WHERE ID = ?";
                                ...
                                if (resultSet.next()) {
                    %>
                    <form method="post" action="prosesUpdateDimsum.jsp">
                        ...
                        out.println("Dimsum not found.");
                            ...
                            out.println("Error: " + e.getMessage());
                                ...
                                if (connection != null) try { connection.close(); } catch (SQLException ignore) {}
                                    ...
                                    out.println("No Dimsum ID provided.");
                                    }
                    %>
                </div>
            </div>
